...
//    pub module_path: OsStr,
//    /// The arguments to pass.
//    pub args: Vec<OsStr>,
//    /// The environment of the process.
//    pub env: HashMap<OsStr,OsStr>,
//}
//
//impl Command {
...
//    pub fn new<T: AsRef<OsStr> + ?Sized>(module_path: T) -> Command {
//        Command {
//            module_path: module_path.as_ref(),
//            args: Vec::new(),
//            env: HashMap::new(),
//        }
//    }
...
//    pub fn arg<'a,T: AsRef<OsStr> + ?Sized>(&'a mut self, arg: T) -> &'a mut Command {
//        self.args.push(arg.as_ref());
//        self
//    }
//
//    /// Adds multiple arguments to pass to the program.
//    pub fn args<'a,T: AsRef<OsStr> + ?Sized>(&'a mut self, args: &[T]) -> &'a mut Command {
//        self.args.extend(args.iter().map(|arg| arg.as_ref()));
//        self
//    }
//
//    /// Inserts or updates an environment variable mapping.
//    pub fn env<'a,T: AsRef<OsStr> + ?Sized, U:AsRef<OsStr> + ?Sized>(&'a mut self, key: T, val: U) -> &'a mut Command {
//        self.env.insert(key.as_ref(),
//                        val.as_ref());
//        self
//    }
//
